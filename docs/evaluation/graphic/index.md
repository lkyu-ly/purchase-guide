...
从而另一角度来看，RTX50 系列最大的亮点恐怕是其基于 TSMC 5nm 工艺带来的惊人能效比：RTX5070 仅需要不到 100W 的功耗就能超越 RTX3080 在 180W 时的性能，堪称外星科技！毫无疑问，极高的能效比对于那些关注机身三围的性能本用户是一个巨大利好，因为这使得这些用户仍可以在充电设备功率受限的情况下拥有相当的图形性能。所以同学你完全可以期待市场上那些具有轻薄设计的性能本的表现，比如[天选的 Air 系列](/recommend/华硕天选Air)。
