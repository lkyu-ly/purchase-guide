...
四年前，市场上的主流内存规格正在从 DDR4 向 DDR5 演进，许多产品都搭载了 DDR5 内存。至于 DDR5 内存的特性及其最终的性能表现，可类比具有高内存带宽和高内存延迟的 HEDT 平台，而事实结果也与该类比一致：初代 DDR5 内存除了在少部分的专业软件上胜出，在大多数的专业软件和几乎所有的游戏上都不如现今的 DDR4 内存。而在四年之后的今天，市场上的笔记本基本上都搭载高频 DDR5 内存，照如此发展趋势，DDR5 内存取代 DDR4 内存已只是时间问题。不过，伴随着去年年末的 AI 热潮引起的内存固态涨价风波，目前的 DDR5 与 DDR4 内存价格相较于低价时几乎翻了三倍，许多笔记本厂商为了应对这次涨价风波，也纷纷上调了笔记本的售价，而许多 DIY 玩家为了减少自己的预算，也不得不将自己的眼光重新投向 D4 平台。但内存本质是可大批量生产的工业品，此次内存涨价更多的是 AI 扩张与黄牛囤货共同影响的结果，等到内存泡沫破灭的那天，或许游戏玩家们又能享受到物美价廉的内存产品。因此我们建议您，如果您不是必须要购买笔记本，请不要陷入消费主义的陷阱。您可以继续使用您目前的笔记本，等到 1-2 年后内存与硬盘价格下跌后再考虑换新。
