...
<template>
	<div v-if="visible" class="bulletin-wrapper" style="width: 300px">
		...
		<div class="bulletin-content">
			<p class="bulletin-p">记住！买电脑一定要用<b style="color: red">国补</b>！！！</p>
			<p class="bulletin-p">
				如果您所在的地区不支持国补，那我们<b style="color: red">不推荐</b
				>你买任何笔记本电脑，直至购机价格与其他有国补的地区保持一致。
			</p>
			<!-- <hr> -->
			<div class="btn-group">
				<a class="btn" href="/introduction/购买#国补">详情</a>
			</div>
		</div>
	</div>
</template>
